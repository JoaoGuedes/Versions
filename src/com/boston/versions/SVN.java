...
public class SVN extends Repository {
	...
	public SVN(Context context, String name, String user, String password, String address) {
		super(name, user, password, address);
		mContext = context;
		SetType(1);
	}
	
	public SVN(Context context, int id, String name, String user, String password, String address, int type, long lastUpdate, long headRevision,
